...
const SetUpScreen = () => {
  return (
    <div className='h-screen w-screen bg-black overflow-hidden'>
        ...
        <div className='grid grid-cols-[1fr_3fr] h-screen rounded-sm px-10'>
            ...
            <div className="text-center mt-16">
                <h2 className="text-6xl text-white font-[Black_Ops] font-semibold">HI Anshu!!</h2>
                <p className="text-gray-400 font-[sixty] mt-6 text-2xl">
